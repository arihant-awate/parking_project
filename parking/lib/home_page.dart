  ...
  Future<void> _loadUserParkingSpots() async {
    final response = await Supabase.instance.client
        ...
        .eq(
            'username',
            UserModel
                .currentUser!.username); // Filter by current user's username
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                          labelText: 'Four Wheeler Hourly Charges'),
                    ),
                    SizedBox(
                      height: 15,
                    ),
                    TextField(
                      ...
                      decoration:
                          InputDecoration(labelText: 'Two Wheeler Hourly Charges'),
                    ),
                    SizedBox(
                      height: 15,
                    ),
    ...
    return Scaffold(
      ...
      floatingActionButton: Padding(
        padding: const EdgeInsets.only(
            right: 300.0), // Place the FAB on the left side
        child: FloatingActionButton(
          onPressed: isEditMode
              ? _saveParkingSpot
              : null, // Only allow saving in edit mode
